  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid place-content-center text-current transition-none group"
      >
        <Check className="size-3.5 group-data-[state=indeterminate]:hidden" strokeWidth={3} />
        <Minus className="size-3.5 hidden group-data-[state=indeterminate]:block" strokeWidth={3} />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
  )
}
